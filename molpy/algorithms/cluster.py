...
# date: 2021-10-28
# version: 0.0.1
# source: https://github.com/networkx/networkx/blob/main/networkx/algorithms/cluster.py
# description: Algorithms to characterize the number of triangles in a graph.
