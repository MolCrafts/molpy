...
# date: 2022-07-15
# version: 0.0.1
# source: http://prody.csb.pitt.edu/_modules/prody/trajectory/dcdfile.html#DCDFile
...
from molpy.io import fileHandler

now = datetime.datetime.now
import numpy as np
from molpy.io import ioLog
...
class DCDReader:
    ...
    def _parseHander(self):
        ...
        self._file = dcd = self.filehandler.fp
...
class DCDWriter:
    ...
    def __init__(self, fpath):
        ...
        self.filepath = fpath
        self.filehandle = fileHandler(fpath, 'wb')
