...
- [dielectric-susceptibility-03-python-types](dielectric-susceptibility-03-python-types.md) — Python 数据容器：ACFResult + SpectralResult + DielectricResult + DielectricSusceptibilityResult (frozen dataclasses) [approved]
