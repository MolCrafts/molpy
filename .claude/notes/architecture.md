...
- **mp.Frame / mp.Block** — Numerical containers are imported directly from molrs. `core/frame.py`, top-level aliases, and `molpy.core` aliases are deleted; no compatibility import path, `_inner`, or conversion bridge exists.
