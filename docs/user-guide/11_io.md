...
This page describes how MolPy reads and writes molecular data, force fields, and trajectories. To add support for a **new** format, see [Developer Guide: I/O Formats](../developer/extending-io.md).
