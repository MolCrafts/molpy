...
class PolymerBuilder:
    ...
    def register_monomer(self, name: str, template: MonomerTemplate) -> "PolymerBuilder":
        ...
        Args:
            ...
            template: MonomerTemplate instance
    ...
    def get_anchor_atoms(self, template: MonomerTemplate, anchor_name: str,
                        prev_monomer: Optional[str] = None, 
                        next_monomer: Optional[str] = None) -> List[Atom]:
        """
        Get anchor atoms based on context-aware rules.
        
        Args:
            template: MonomerTemplate to get anchors from
    ...
    def build_branched(self, backbone_sequence: List[str], 
                      branches: Dict[int, List[str]], **kwargs) -> AtomicStructure:
        """
