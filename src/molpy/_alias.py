...
Alias = _Aliases("default", {
            ...
            "positions": _Alias("positions", "_xyz", np.ndarray, "angstrom", "atomic coordinates"),
            "R": _Alias("R", "_xyz", np.ndarray, "angstrom", "atomic coordinates"),
            ...
            "radius": _Alias("radius", "_radius", float, "angstrom", "atomic radius"),
            "color": _Alias("color", "_color", str, None, "color"),
            "weight": _Alias("weight", "_weight", float, None, "atomic weight"),
            ...
            "atomtype": _Alias("atomtype", "_atomtype", str, None, "atom type"),
            "bondtype": _Alias("bondtype", "_bondtype", str, None, "bond type"),
            "angletype": _Alias("angletype", "_angletype", str, None, "angle type"),
            "dihedraltype": _Alias("dihedraltype", "_dihedraltype", str, None, "dihedral type"),
            "impropertype": _Alias("impropertype", "_impropertype", str, None, "improper type"),
            "index": _Alias("index", "_index", int, None, "index"),
        })
