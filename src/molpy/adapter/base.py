...
class Adapter(ABC, Generic[InternalT, ExternalT]):
    ...
    def _do_sync_to_internal(self) -> None:
        """Implement the actual sync logic from external to internal.

        This method is called by sync_to_internal() after validation.
    ...
    def _do_sync_to_external(self) -> None:
        """Implement the actual sync logic from internal to external.

        This method is called by sync_to_external() after validation.
        Subclasses must implement this method.
        """
        pass
