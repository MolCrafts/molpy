...
This module implements the MCD method for computing self and distinct displacement
correlations (MSD) from molecular dynamics trajectories.
...
class MCDCompute(Compute["Trajectory", MCDResult]):
    ...
    of particle displacements. It returns raw MSD values without fitting. It supports:
    ...
    Args:
        tags: List of atom type specifications. Each tag can be:
            ...
            - Two integers separated by comma (e.g., "3,4"): Distinct diffusion correlation between types 3 and 4
    ...
    def _remove_com(self, coords: NDArray, elems: NDArray) -> NDArray:
        ...
        if self.center_of_mass is None:
            raise ValueError("center_of_mass must be provided for COM removal")
